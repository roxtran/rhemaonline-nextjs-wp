    ...
    <>
      ...
      <KidContainer>
        ...
        <div className='items'>
          <div className='item'>
            <ImgWrapper>
              <Image src='/img/about-kid-world.jpg' layout='fill' objectFit='cover' />
            </ImgWrapper>
              ...
              <div className='text-wrapper'>
                ...
                <div className='icons'>
                  ...
                  <a title='Facebook' href='https://www.facebook.com/groups/19841422285/about/' target='_blank'>
                    <div className='icon'>
                      <Image src='/img/social/facebook-icon-blue.svg' width={42} height={42} />
                    </div>
                  </a>
                  <a title='Twitter' href='https://twitter.com/rhemakidsworld' target='_blank'>
                    <div className='icon'>
                      <Image src='/img/social/twitter-icon-blue.svg' width={42} height={42} />
                    </div>
                  </a>
                </div>
              </div>
          ...
          <div className='item'>
            <ImgWrapper>
              <Image src='/img/children-church.jpg' layout='fill' objectFit='cover' />
            </ImgWrapper>
            <div className='content-wrapper'>
              <div className='text-wrapper'>
