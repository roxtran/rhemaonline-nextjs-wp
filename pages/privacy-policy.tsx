        ...
        <div className="content-wrapper">
          ...
          <ul>
            ...
            <li>
              ...
              <span>
                {" "}
                (referred to as either "the Company," "We," "Us," or "Our" in this Agreement) refers to Rhema Canada.
              </span>
            </li>
            <li>
              <b>
            ...
            <li>
              ...
              <span>refers to Rhema Canada, accessible from </span>
              <a href="http://www.rhemacanada.org/">
                <span>www.rhemacanada.ca</span>
              </a>
            </li>
            <li>
              <b>
          ...
          <br />
          <p>
            Rhema Canada collects and uses the information contained within an automatically created traffic log on our
            website. JavaScript, Cookies, and other tracking codes are included on all pages of our websites for use
            with Google Analytics. We use this information in a combined form to calculate overall site traffic
            patterns, analyze user trends, and administer the website. We use Cookies and similar tracking technologies
            to track the activity of our service and store certain information. Tracking technologies are beacons, tags,
            and scripts to collect and track information and improve and analyze our Service. The technologies we use
            may include:
          </p>
          <ul>
            <li>
          ...
          <p>
            For more information about the Cook may include information such as your Device's Internet Protocol address
            (e.g., IP address), browser type, browser version, the pages of our Service that you visit, the time and
            date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data. When
            you access the Service by or through a mobile device, We may collect certain information automatically,
            ...
            unique device identifiers and other diagnostic data. We may also collect information that your browser sends
            whenever you visit our Service or access the Service through a mobile device we use and your choices
            regarding Cookies, please visit the Cookies section of our Privacy Policy.
          </p>
          <b>
          ...
          <br />
          <p>This Privacy Policy applies only to sites and apps operated by Rhema Canada.</p>
          <p>
            ...
            Rhema Canada. As noted above, third-party sites associated with our sites may collect information using
            automated technologies such as Cookies. We have no control over and assume no responsibility for third-party
