...
export default function Index() {
  ...
  return (
    <>
      ...
      <HeadLine imgUrl={pageImage} title={pageTitle} blur="blur(0.25rem)" height="61.25rem" mbHeight="22rem" />
      <PageContainer>
        <h1 id="title">Together we build the house of God</h1>
        <p className="description highlight">
          Join us in building a home where worship, spiritual growth, and God’s presence thrive.
        </p>
        <div className="wrapper build">
          ...
          <div className="right-wrapper flex-column highlight-border-top">
            ...
            <p className="gift">Every gift, big or small, bring us closer to fund our new home!</p>
            {giveBtn}
        ...
        <div id="message" className="wrapper pastor introduction">
          <div className="left-wrapper">
            <h2 className="highlight">From our senior paster</h2>
            <p>
          ...
          <div className="right-wrapper">
            <VideoWrapper>
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/Up-v7akN5xA?rel=0&showinfo=1&autoplay=0&loop=0"
        ...
        <div id="the-reason" className="wrapper reason">
          <div className="reason-wrapper">
            ...
            <p>
              ...
              older adults through vital programs like our food bank, which provides essential aid to those in need.
              This new space will allow us to continue this work unhindered while creating a hub for community growth
              and transformation.
            </p>
            <p>
              ...
              reach these targets, ensuring we secure a space that reflects the heart of Rhema Christian Ministries:
              building community, offering hope, and advancing God’s Kingdom. Let’s grow together as we build together.
            </p>
          </div>
        </div>
        <div id="the-numbers" className="wrapper numbers">
          ...
          <div className="funded-raised flex-column">
            <div className="number highlight">$7.5K+</div>
            <div className="subtitle">
              <b>Fund Raised</b>
        ...
        <div id="our-project" className="wrapper flex-column">
          ...
          <div className="button-wrapper">
            ...
            <Button href="#message">Message from our CEO</Button>
        ...
        <div id="introduction" className="wrapper introduction">
          <div className="left-wrapper">
            ...
            <p>
              ...
              serving families - children, young and older adults alike - with care and compassion. A cornerstone of
              this mission is our food bank, which provides essential support to individuals and families in need. This
              vital service has been a lifeline for so many, and we are committed to continuing this work unhindered.
            </p>
          </div>
        ...
        <div className="wrapper introduction">
          ...
          <div className="left-wrapper">
            <p>
              ...
              provides resources for children to thrive, ensures our older adults are cared for with dignity, and
              sustains our food bank operations as a beacon of hope for the hungry.
            </p>
            <p>
            ...
            <p>
              ...
              space that reflects the heart of Rhema Christian Ministries: changing lives, building community, and
        ...
        <div id="goals" className="wrapper goals">
          ...
          <p className="description">
            As the campaign gains momentum, we’ll host community outreach events, including dinner gatherings and
            service days, while continuing to engage church members through social media, email updates, and pledge
            drives.
          </p>
        ...
        <div className="wrapper help-us flex-column">
          <p className="description">Helps us move closer to creating a lasting legacy</p>
